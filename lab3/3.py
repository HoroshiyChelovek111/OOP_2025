...
def draw_person(surface, x, y):
    ...
    ellipse(screen, skin_color1, (150, 100, 30, 50))  # лодошка1
    ellipse(screen, skin_color, (720, 100, 30, 50))  # лодошка2
    ellipse(screen, skin_color, (450, 100, 30, 50))  # лодошка1
    ellipse(screen, skin_color1, (420, 100, 30, 50))  # лодошка2
...
# Табличка
polygon(screen, (0, 0, 0), [(100, 80), (100, 115), (800, 115), (800, 80)], 5)  # обводка таблички
polygon(screen,(0,255,0),[(100, 80), (100, 115), (800, 115), (800, 80)])  # табличка
